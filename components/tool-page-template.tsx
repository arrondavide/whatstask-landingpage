      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <main className="container mx-auto px-4 py-12">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">{shortDescription}</p>
          </motion.div>
            ...
            {iframeSource ? (
              ...
              <div className="w-full h-[600px] md:h-[700px] flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-xl text-gray-400 font-light">{toolName} loads here</p>
                </div>
              </div>
            )}
          </motion.div>
          ...
          >
            ...
            <p className="text-lg text-gray-300 leading-relaxed mb-8">{fullDescription}</p>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <p className="text-gray-300 font-light leading-relaxed">{feature}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
          ...
          >
            ...
            <Accordion type="single" collapsible className="w-full space-y-4">
              {faqs.map((faq, index) => (
                ...
                >
                  <AccordionTrigger className="text-lg font-semibold py-4 hover:text-gray-300 transition-colors">
                    {faq.question}
                  </AccordionTrigger>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {relatedTools.map((tool, index) => (
                ...
                >
                  <h3 className="text-xl font-bold mb-2 group-hover:text-gray-300 transition-colors">{tool.name}</h3>
                  <p className="text-gray-400 font-light text-sm mb-4 leading-relaxed">{tool.description}</p>
                  <Link
                    href={`/${tool.slug}`}
          ...
          <div className="container mx-auto px-4 py-12">
            <div className="grid md:grid-cols-4 gap-8 mb-12">
              <div>
                ...
                <p className="text-gray-400 font-light text-sm">Free online tools and task management for 2025.</p>
              </div>
              <div>
