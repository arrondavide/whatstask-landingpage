    ...
    <>
      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <main className="container mx-auto px-4 py-12">
          ...
          <section className="max-w-4xl mx-auto mb-16">
            <div className="bg-gradient-to-br from-teal-500/10 to-white/5 rounded-3xl p-8 border border-teal-500/20">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="font-bold text-teal-400 mb-2">Whatstask</h3>
                ...
                <div>
                  <h3 className="font-bold text-gray-400 mb-2">Notion</h3>
          ...
          <section className="max-w-5xl mx-auto mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                <Zap className="h-10 w-10 text-teal-400 mx-auto mb-4" />
                <h3 className="text-lg font-bold mb-2">Philosophy</h3>
                <p className="text-gray-400 text-sm mb-4">Notion: Build anything you want</p>
                <p className="text-teal-400 font-medium">Whatstask: We built it for you</p>
              </div>
              <div className="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                <Clock className="h-10 w-10 text-teal-400 mx-auto mb-4" />
                <h3 className="text-lg font-bold mb-2">Time to Productive</h3>
                <p className="text-gray-400 text-sm mb-4">Notion: Hours/days of setup</p>
                <p className="text-teal-400 font-medium">Whatstask: 30 seconds</p>
              </div>
              <div className="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                <FileText className="h-10 w-10 text-teal-400 mx-auto mb-4" />
                <h3 className="text-lg font-bold mb-2">Scope</h3>
                <p className="text-gray-400 text-sm mb-4">Notion: Everything in one place</p>
                <p className="text-teal-400 font-medium">Whatstask: Tasks done right</p>
              </div>
            </div>
          </section>
              ...
              <table className="w-full min-w-[500px]">
                <thead>
                  <tr className="border-b border-white/10 bg-white/5">
                    ...
                    <th className="text-center p-4 font-bold text-gray-500">Notion</th>
                  </tr>
                </thead>
                <tbody>
                  {comparison.map((row, index) => (
                    <tr key={index} className="border-b border-white/5 hover:bg-white/5">
                      ...
                      <td className={`p-4 text-center ${row.winner === "whatstask" ? "text-teal-400" : ""}`}>
                        {row.whatstask}
                        {row.winner === "whatstask" && <Check className="h-4 w-4 inline ml-2" />}
                      </td>
                      <td className={`p-4 text-center ${row.winner === "notion" ? "text-gray-300" : "text-gray-500"}`}>
                        {row.notion}
          ...
          <section className="max-w-4xl mx-auto mb-16">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-teal-500/10 to-white/5 rounded-2xl p-6 border border-teal-500/30">
                <h3 className="font-bold text-teal-400 mb-4">Choose Whatstask if:</h3>
              ...
              <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                <h3 className="font-bold text-gray-400 mb-4">Choose Notion if:</h3>
