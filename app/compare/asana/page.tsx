          ...
          <section className="max-w-4xl mx-auto mb-16">
            <div className="bg-gradient-to-br from-teal-500/10 to-white/5 rounded-3xl p-8 border border-teal-500/20">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  <h3 className="font-bold text-gray-400 mb-2">Choose Asana if:</h3>
          ...
          <section className="max-w-5xl mx-auto mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                ...
                <p className="text-gray-400 text-sm mb-4">Asana: Enterprise tier only</p>
                <p className="text-teal-400 font-medium">Whatstask: Free for everyone</p>
              </div>
              <div className="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                <Clock className="h-10 w-10 text-teal-400 mx-auto mb-4" />
                <h3 className="text-lg font-bold mb-2">Setup Time</h3>
                <p className="text-gray-400 text-sm mb-4">Asana: Weeks of configuration</p>
              ...
              <div className="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                ...
                <p className="text-gray-400 text-sm mb-4">Asana: Steep learning curve</p>
                <p className="text-teal-400 font-medium">Whatstask: Start instantly</p>
              </div>
            </div>
          </section>
                ...
                <tbody>
                  {comparison.map((row, index) => (
                    <tr key={index} className="border-b border-white/5 hover:bg-white/5">
                      ...
                      <td className={`p-4 text-center ${row.winner === "asana" ? "text-gray-300" : "text-gray-500"}`}>
                        {row.asana}
