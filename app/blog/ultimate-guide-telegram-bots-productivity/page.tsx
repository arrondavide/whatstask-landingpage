      ...
      <div className="min-h-screen bg-[#0a0a0a] text-white pt-16">
        ...
        <article className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto">
            {/* Meta */}
            <div className="flex items-center gap-4 mb-6 text-neutral-300">
            ...
            <div className="prose prose-invert max-w-none">
                ...
                {taskBots.map((bot, idx) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <span className="text-sm text-neutral-300">{bot.pricing}</span>
                    </div>
                    <p className="text-neutral-300 mb-4">{bot.description}</p>
                    <div className="mb-4">
                      <span className="text-sm text-neutral-400 font-medium">Best for: </span>
                      <span className="text-sm text-neutral-300">{bot.bestFor}</span>
                    </div>
                    <div className="space-y-2 mb-4">
                      {bot.pros.map((pro, proIdx) => (
                        <div key={proIdx} className="flex items-center gap-2 text-sm text-neutral-300">
              ...
              <div className="bg-violet-500/10 border border-violet-500/20 rounded-xl p-6 mb-8">
                <p className="text-neutral-300 font-medium mb-2">Expert Tip:</p>
              ...
              <p className="text-neutral-300 leading-relaxed mb-6">Here's a proven roadmap for your first week:</p>
            ...
            <div className="mt-12">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <p className="text-neutral-300 text-sm">Detailed comparison of features and pricing</p>
                </Link>
                <Link
                  href="/compare/skeddy"
                  className="bg-white/5 backdrop-blur-lg rounded-xl p-6 border border-white/10 hover:border-white/20 transition-all"
                >
                  ...
                  <p className="text-neutral-300 text-sm">Compare the two top Telegram task bots</p>
                </Link>
              </div>
            </div>
          </div>
