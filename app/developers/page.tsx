...
import { ArrowRight, Check, Copy, Zap, Shield, Clock, Code, Webhook, Bell, Terminal } from "lucide-react"
        ...
        <main className="container mx-auto px-4 py-16 max-w-5xl">
          ...
          <section className="text-center mb-20">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-emerald-200 bg-emerald-50 mb-6">
              ...
              <span className="text-emerald-700 text-sm font-medium">Developer API</span>
            </div>
          ...
          <section className="mb-24">
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={index} className="border border-slate-200 rounded-2xl p-8 hover:border-slate-300 hover:shadow-md transition-all">
          ...
          <section id="quickstart" className="mb-24">
            <div className="text-center mb-12">
              <p className="text-xs uppercase tracking-widest text-emerald-600 mb-4">Quick Start</p>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900">Send your first notification</h2>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="border border-slate-200 rounded-2xl p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-slate-900">Get your API key</h3>
                </div>
                <p className="text-slate-500 mb-6">
                  Open WhatsTask in Telegram, go to <strong>Profile → Developer API → Create Key</strong>. Copy and save your key securely.
                </p>
              ...
              <div className="border border-slate-200 rounded-2xl p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-slate-900">Send a notification</h3>
                </div>
                <p className="text-slate-500 mb-6">
    ...
    "priority": "high"
              ...
              <div className="border border-slate-200 rounded-2xl p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-slate-900">That's it!</h3>
                </div>
          ...
          <section id="api-reference" className="mb-24">
            <div className="text-center mb-12">
              <p className="text-xs uppercase tracking-widest text-emerald-600 mb-4">API Reference</p>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900">POST /api/v1/notify</h2>
            </div>

            <div className="border border-slate-200 rounded-2xl overflow-hidden">
              {/* Request Parameters */}
              <div className="p-8 border-b border-slate-200">
                <h3 className="text-lg font-semibold text-slate-900 mb-6">Request Body</h3>
                <div className="space-y-4">
                  {[
                    ...
                    <div key={index} className="flex items-start gap-4 py-4 border-b border-slate-100 last:border-0">
              ...
              <div className="p-8 bg-slate-50">
                <h3 className="text-lg font-semibold text-slate-900 mb-6">Response</h3>
  ...
  "data": {
    ...
    "timestamp": "2026-02-12T10:30:00.000Z"
          ...
          <section id="code-examples" className="mb-24">
            <div className="text-center mb-12">
              <p className="text-xs uppercase tracking-widest text-emerald-600 mb-4">Code Examples</p>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900">In your language</h2>
            </div>
              ...
              <div className="border border-slate-200 rounded-2xl overflow-hidden">
                <div className="px-6 py-4 border-b border-slate-200 bg-slate-50 flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-blue-100 flex items-center justify-center">
                    <span className="text-blue-700 font-bold text-xs">PY</span>
                  </div>
              ...
              <div className="border border-slate-200 rounded-2xl overflow-hidden">
                <div className="px-6 py-4 border-b border-slate-200 bg-slate-50 flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-cyan-100 flex items-center justify-center">
                    <span className="text-cyan-700 font-bold text-xs">GO</span>
                  </div>
              ...
              <div className="border border-slate-200 rounded-2xl overflow-hidden">
                <div className="px-6 py-4 border-b border-slate-200 bg-slate-50 flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-purple-100 flex items-center justify-center">
                    <span className="text-purple-700 font-bold text-xs">GH</span>
                  </div>
                  <span className="font-semibold text-slate-900">GitHub Actions</span>
                </div>
                <pre className="p-6 text-sm overflow-x-auto bg-[#1a1a1a]">
                  <code className="text-neutral-300">
      ...
      -d '{
        ...
        "link": "\${{ github.server_url }}/\${{ github.repository }}/actions/runs/\${{ github.run_id }}"
          ...
          <section id="webhooks" className="mb-24">
            <div className="text-center mb-12">
              <p className="text-xs uppercase tracking-widest text-emerald-600 mb-4">Webhooks</p>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900">Receive events from any service</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              {/* Supported Services */}
              <div className="border border-slate-200 rounded-2xl p-8">
                <h3 className="text-lg font-semibold text-slate-900 mb-6">Supported services</h3>
                <p className="text-slate-500 mb-6 text-sm">We auto-parse webhooks from these services:</p>
            ...
            <div className="mt-8 border border-slate-200 rounded-2xl p-8">
              <h3 className="text-lg font-semibold text-slate-900 mb-6">Webhook actions</h3>
              <p className="text-slate-500 mb-6">Choose what happens when a webhook is received:</p>
              <div className="grid md:grid-cols-3 gap-4">
                {[
                  ...
                  <div key={index} className="bg-slate-50 rounded-xl p-6">
                    <code className="text-sm font-semibold text-emerald-600">{item.action}</code>
          ...
          <section id="pricing" className="mb-24">
            <div className="text-center mb-12">
              <p className="text-xs uppercase tracking-widest text-emerald-600 mb-4">Pricing</p>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900">Simple, predictable pricing</h2>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {[
                ...
                { tier: "Pro", price: "$49", notifications: "100,000/mo", rate: "300/min", features: ["Everything in Starter", "Custom rate limits", "Dedicated support"] },
                { tier: "Enterprise", price: "Custom", notifications: "Unlimited", rate: "Custom", features: ["Everything in Pro", "SLA", "Custom integrations"] },
              ].map((plan, index) => (
                <div key={index} className={`border rounded-2xl p-6 ${index === 2 ? 'border-emerald-300 bg-emerald-50' : 'border-slate-200'}`}>
                  <p className="text-sm font-medium text-slate-500 mb-1">{plan.tier}</p>
                  <p className="text-3xl font-bold text-slate-900 mb-4">{plan.price}<span className="text-sm font-normal text-slate-500">/mo</span></p>
                  <div className="space-y-2 mb-6">
                    <p className="text-sm text-slate-600"><strong>{plan.notifications}</strong> notifications</p>
                    <p className="text-sm text-slate-600"><strong>{plan.rate}</strong> rate limit</p>
                  </div>
          ...
          <section id="errors" className="mb-24">
            <div className="text-center mb-12">
              <p className="text-xs uppercase tracking-widest text-emerald-600 mb-4">Error Handling</p>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900">Common errors</h2>
            </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-slate-200 bg-slate-50">
                    ...
                    <th className="text-left p-4 font-semibold text-slate-900">Error</th>
                    <th className="text-left p-4 font-semibold text-slate-900">Solution</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={index} className="border-b border-slate-100 last:border-0">
                      <td className="p-4"><code className="text-red-600 bg-red-50 px-2 py-1 rounded text-sm">{row.status}</code></td>
                      <td className="p-4 text-slate-700">{row.error}</td>
                      <td className="p-4 text-slate-500 text-sm">{row.solution}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <section id="best-practices" className="mb-24">
            <div className="text-center mb-12">
              <p className="text-xs uppercase tracking-widest text-emerald-600 mb-4">Best Practices</p>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900">Recommendations</h2>
            </div>
          ...
          {/* CTA */}
          <section>
            <div className="border border-emerald-200 bg-emerald-50 rounded-2xl p-10 md:p-16 text-center">
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Ready to start sending?</h2>
